...
public class VueGrille extends Observable {
    ...
    public VueGrille(){
            ...
            panelHaut.add(new JLabel("Match n° x, w contre y"));
            ...
            panelGauche.add(new JLabel("Pseudo joueur 1"));
            panelGauche.add(new JLabel("Signe joueur 1"));
            
            JPanel panelDroite = new JPanel();
            mainPanel.add(panelDroite, BorderLayout.EAST);
            panelDroite.add(new JLabel("Pseudo joueur 1"));
            panelDroite.add(new JLabel("Signe joueur 1"));
